...
(function(pidlist, classbase) {
	...
	FailCode: {
		bdIgnoreBP: "bdIgnoreBP.kramma",
		bdCrossBP: "bdCrossBP.kramma",
		bdCurveExBP: "bdCurveExBP.kramma",
		bdBranch: "bdBranch.kramma",
		bkPlNum: "bkPlNum.kramma",
		bkNoNum: "bkNoNum.kramma"
	},
	"FailCode@shwolf": {
		bkNoNum: [
			"ヤギもオオカミもいない領域があります。",
